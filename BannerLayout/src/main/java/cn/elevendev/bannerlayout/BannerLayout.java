...
import cn.elevendev.bannerlayout.layoutmanager.BannerLayoutManager;
import cn.elevendev.bannerlayout.layoutmanager.CenterSnapHelper;
...
public class BannerLayout extends FrameLayout {
    ...
    protected void initView(@NonNull Context context, AttributeSet attrs) {
        ...
        itemSpace = a.getDimensionPixelSize(R.styleable.BannerLayout_itemSpace, dp2px(15));
        ...
        if (mUnselectedDrawable == null) {
            ...
            unSelectedGradientDrawable.setColor(Color.parseColor("#CDCDCD"));
